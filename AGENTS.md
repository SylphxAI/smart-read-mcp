# Smart Read MCP Agent Instructions

Read `README.md`, `PROJECT.md`, and `docs/adr/0001-boundary.md` before implementing.

Portfolio rules live in [pdf-reader-mcp ADR-0004](https://github.com/SylphxAI/pdf-reader-mcp/blob/main/docs/adr/0004-reader-portfolio-architecture.md).
